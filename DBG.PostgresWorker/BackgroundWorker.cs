    ...
    : IHostedService, IDisposable
{
    ...
    {
        _timer4 = new Timer(connectionManager.LoadConnections, null, TimeSpan.FromSeconds(15),
        ...
        _timer2 = new Timer(connectionManager.ReadDbStaticState, null, TimeSpan.FromMinutes(1),
            TimeSpan.FromMinutes(1));
        _timer3 = new Timer(connectionManager.ConnectToNewDatabases, null, TimeSpan.FromMinutes(1),
            TimeSpan.FromMinutes(1));
    ...
    public Task StopAsync(CancellationToken stoppingToken)
    {
        ...
        _ = _timer4?.Change(Timeout.Infinite, 0);
