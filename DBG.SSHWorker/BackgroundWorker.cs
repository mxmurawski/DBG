    ...
    : IHostedService, IDisposable
{
    ...
    public Task StartAsync(CancellationToken stoppingToken)
    {
        ...
        _timer1 = new Timer(connectionManager.ReadOsDynamicState, null, TimeSpan.FromMinutes(1),
            TimeSpan.FromMinutes(1));
        _timer2 = new Timer(connectionManager.ReadOsStaticState, null, TimeSpan.FromMinutes(1),
            TimeSpan.FromMinutes(1));
